...
- Completed T018: added `tests/test_security_control_characters.py` as a control-character injection matrix covering tables, selector labels, CLI errors, add/sync result output, and source git paths (repo IDs, repo URLs, Git stderr/stdout, and OS errors).
