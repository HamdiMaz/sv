...
The picker shows the visible range and controls at the bottom. Use ↑/↓ to move, `/` to search with a visible prompt, Space to select, Enter to confirm, and `q` to cancel.
