...
| `sv add -l` picker | Partial | Uses checkbox selector, but it is a single-column label list rather than a table with aligned Skill/Source/Description columns. See `src/sv/selector.py:260-319`. |
